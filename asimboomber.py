...
def logo():
    ...
    print("\033[94m│     \033[92m   ___   __________  ___  ___  ____  ____  __  ______  _______         \033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m   / _ | / __/  _/  |/  / / _ )/ __ \/ __ \/  |/  / _ )/ __/ _ \\033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m  / __ |_\ \_/ // /|_/ / / _  / /_/ / /_/ / /|_/ / _  / _// , _/  \033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m /_/ |_/___/___/_/  /_/ /____/\____/\____/_/  /_/____/___/_/|_|  \033[94m   │".center(columns+15))
...
def check(sent):
    ...
    if (sent == amount):
        ...
        time.sleep(0.6)
        print("\033[92m[\033[93m★\033[92m] Thanks For Using Our Tool[TOXIC-TEAM] \033[92m[\033[93m★\033[92m]".center(columns + 30))
        print("\033[37m")
